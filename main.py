    ...
    try:
        with engine.begin() as conn:
            ...
            conn.execute(text("""
                ...
                VALUES 
                ((SELECT category_id FROM categories WHERE category_name = 'Instagram Feed' LIMIT 1), 'Promo Diskon Kripik Nusantara',
                ...
                ((SELECT category_id FROM categories WHERE category_name = 'Poster Promo' LIMIT 1), 'Poster Menu Ayam Bakar',
                ...
                ((SELECT category_id FROM categories WHERE category_name = 'Template Livestream' LIMIT 1), 'Livestream Overlay Fashion',
                ...
                ((SELECT category_id FROM categories WHERE category_name = 'Katalog Produk' LIMIT 1), 'Katalog Hijab Syari Modern',
                ...
                ((SELECT category_id FROM categories WHERE category_name = 'Banner Marketplace' LIMIT 1), 'Banner Toko Shopee Fashion',
                ...
                ((SELECT category_id FROM categories WHERE category_name = 'Instagram Feed' LIMIT 1), 'Menu Kopi Susu Senja',
                ...
                ((SELECT category_id FROM categories WHERE category_name = 'Poster Promo' LIMIT 1), 'Promo Hijab Muslimah',
